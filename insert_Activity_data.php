        ...
        <div class="col-md-12">
          <div class="card border border-success" style="margin-top:40px;">
            <div class="card-header bg-success" style="text-align:center;">
              <h4 class="text-white">Insert Activity Packages</h4>
            </div>
            <div class="card-body">
            ...
            <form action="Des_CRUD.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group" >
                ...
                <input type="text" name="location" required class="form-control border border-success" placeholder="Enter Location">
              </div>
              <br>
              <div class="form-group" >
                <label for="">Activity Package Price</label>
                <input type="text" name="price" required class="form-control border border-success" placeholder="Enter Price">
              </div>
              <br>
              <div class="form-group" >
              ...
              <br>
              <div>
                <button type="submit" name="save_act_image" class="btn btn-primary bg-success border border-success">SUBMIT</button>
              </div>
              </form>
              </div>
            </div>
