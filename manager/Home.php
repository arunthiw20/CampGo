        ...
        <div class="header-btn-group">
          ...
          <div class="sub-menu-wrap" id="subMenu">
            <div class="sub-menu">
              ...
              <a href="../Display_destination.php" class="sub-menu-link">
                <img class="contactus" src="../img/add-location.png" alt="" width="10" height="30">
                <P>Add/Edit destinations</P>
                <span>></span>
              </a>
              <a href="../Display_activity.php" class="sub-menu-link">
                <img class="contactus" src="../img/more.png" alt="" width="10" height="30">
                <P>Add/edit activity</P>
                <span>></span>
              </a>
              <a href="../Display_tools.php" class="sub-menu-link">
                <img class="contactus" src="img/exit_3456192.png" alt="">
                <P>Add/edit Equpments</P>
                <span>></span>
              </a>
            </div>
          </div>
            ...
            <li>
              <div class="popular-card">
                <figure class="card-img">
                  <img src="./images/horton3.jpg" alt="Hortain Plains" loading="lazy">
                </figure>
